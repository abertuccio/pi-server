...
echo '{"_default": {"1": {"usuario": "BERTU", "password":"alarma" ,"token": false, tiempo: null}},{"2": {"usuario": "ROU", "password":"alarma", "token": false, tiempo: null}}}' > /home/pi/pi-server/pi-server/db/usuarios.json
