...
echo '{"_default": {"1": {"usuario": "bertu","password": "otoño2011","token": false},"2": {"usuario": "rou","password": "otoño2011","token": false}}}' > /home/pi/pi-server/pi-server/db/usuarios.json
